...
def main():
    ...
    topics = ["Bana bir film onerisinde bulun ve en fazla 30 kelime bu filmi ozetle", "Bana bir Serdar Ortac sarkisindan dortluk ver", "Guzel bir ingilizce kelime ve turkce anlamiyla birlikte paylas. en fazla 30 kelime.", "Turk bir sairden alinti yap; dortlukten ileriye gitmesin"]
